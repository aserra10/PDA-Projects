...
This paper conducts a thorough examination of three tracheostomy outcome prediction models, employing two different fitting methods to select the most effective model. Models undergo evaluation using positive and negative predictive value comparison, accuracy, AUC measure, and coefficient estimates. The results showed that the lasso model with two-way interactions consistently outperforms its counterparts, demonstrating better predictive accuracy compared to all other fitting models. 
